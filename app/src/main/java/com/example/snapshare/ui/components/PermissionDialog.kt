    ...
    override fun getDescription(isPermanentlyDeclined: Boolean): String {
        return if(isPermanentlyDeclined) {
            ...
            "This app needs access to your camera so that you " +
                    "capture images and send it to your friends."
        }
    }
}
...
class StoragePermissionTextProvider: PermissionTextProvider {
    override fun getDescription(isPermanentlyDeclined: Boolean): String {
        return if(isPermanentlyDeclined) {
            ...
            "This app needs access to your storage so that you can " +
...
class LocationPermissionTextProvider: PermissionTextProvider {
    override fun getDescription(isPermanentlyDeclined: Boolean): String {
        return if(isPermanentlyDeclined) {
            ...
            "This app needs Location permission so that you can connect " +
                    "and share images with your friends."
        }
    }
}